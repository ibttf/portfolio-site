...
const Home = () => {
  ...
  const handleFormSubmit = (e) => {
    e.preventDefault();
    emailjs
      .send("service_x93espq", "template_054xuz2", values, "LhaxNOBSEpss1dCSG")
  ...
  return (
    <div className={`${open ? "" : ""} duration-300`}>
      ...
      {/* ===================================================== */}
      <div
        className={`hero bg-[url(../styles/background2.jpg)] h-screen flex text-center`}
        id="home"
      >
        {/* TEXT */}
        <div className="relative w-screen flex flex-col text-white h-screen items-center justify-center">
          ...
          <h2
            className={`${
              heroContentIsVisible ? "fadeInThree" : ""
      ...
      <div id="skills" className="bg-gray-900 h-full">
        ...
        <div className="grid lg:grid-cols-3 2xl:w-8/12 w-11/12 mx-auto text-white">
          <div
            className={`sm:border-4 border-2  border-white py-4 flex flex-col items-center w-full ${
              skillsBoxFirstIsVisible ? "fadeInOne" : ""
            } text-white`}
            ref={skillsBoxFirst}
          >
            <div className="w-full lg:py-6 lg:px-8 pl-12 mx-auto flex items-center lg:justify-center">
              ...
              <h6
                className="2xl:text-3xl lg:text-2xl sm:text-3xl text-lg font-semibold"
                style={{ lineHeight: "100%" }}
              >
                <span className="underline sm:decoration-8 decoration-4 decoration-pink-200">
                  Software
                </span>{" "}
                <br></br>Development
              </h6>
            ...
            <div className="px-6 flex items-center justify-center">
              <div
                className="pr-4 flex flex-col items-center justify-center text-gray-500 font-light"
              ...
              <h6 className="text-gray-400 lg:text-lg sm:text-xl text-xs">
                Experienced in functional and object-oriented programming:
                Javascript, Python, Java, HTML, CSS.
              </h6>
            </div>
          </div>
          <div
            className={`sm:border-x-4 sm:border-b-4 border-2 lg:border-l-0 lg:border-t-4 border-t-0  border-white py-4 flex flex-col items-center w-full ${
              skillsBoxFirstIsVisible ? "fadeInTwo" : ""
            } text-white`}
            ref={skillsBoxFirst}
          >
            <div className="w-full lg:py-6 lg:px-8 pl-12 mx-auto flex items-center lg:justify-center">
              ...
              <h6
                ...
                style={{ lineHeight: "100%" }}
              >
                <span className="underline sm:decoration-8 decoration-4 decoration-blue-200">
                  Frontend Dev
                </span>{" "}
                <br></br>React, Next
              </h6>
            ...
            <div className="px-6 flex items-center justify-center">
              ...
              <h6 className="text-gray-400 lg:text-lg sm:text-xl text-xs">
                Passionate about UI/UX. Experience in HTML, CSS, JS, TS, React,
                Tailwind, SCSS, Netlify, and Vercel.
              </h6>
            </div>
          </div>
          <div
            className={`sm:border-x-4 sm:border-b-4 border-2 lg:border-l-0 lg:border-t-4 border-t-0  border-white py-4 flex flex-col items-center w-full ${
              skillsBoxFirstIsVisible ? "fadeInThree" : ""
            } text-white`}
            ref={skillsBoxFirst}
          >
            <div className="w-full lg:py-6 lg:px-8 pl-12 mx-auto flex items-center lg:justify-center">
              ...
              <h6
                ...
                style={{ lineHeight: "100%" }}
              >
                <span className="underline sm:decoration-8 decoration-4 decoration-green-200">
                  Backend Dev
                </span>{" "}
                <br></br>Node, Django, Gin
              </h6>
            </div>
            <div className="px-6 flex items-center justify-center">
              <div
        ...
        <img
          src={codesnippet}
          className="relative z-0 opacity-20 bottom-24 lg:w-4/12 w-8/12 mx-auto"
        />
      </div>
      ...
      <div id="projects" className="bg-gray-900 h-full">
        <div className="grid lg:grid-cols-3 grid-cols-1 lg:items-center lg:w-10/12 w-11/12 mx-auto">
          <div
            className={` ${projectHeroLeftIsVisible ? "fadeInOne" : ""}`}
            ref={projectHeroLeft}
          >
            <h1
              className={` lg:w-full w-11/12 lg:text-8xl sm:text-6xl text-4xl text-white lg:text-left text-center lg:pt-36 pt-12 font-bold`}
            >
              My Work
            </h1>
          ...
          <div
            className={`col-span-2 xl:-mb-48 md:-mb-36 ${
              projectHeroLeftIsVisible ? "fadeInTwo" : ""
            }`}
            ref={projectHeroRight}
          >
            <img src={bigOne} className="relative w-full " />
            <img
              src={arrow}
              className="-scale-x-100 rotate-180 relative w-2/12 lg:left-24 sm:left-16 left-4"
            />
      ...
      <div id="contact" className="bg-gray-900 lg:pt-48 sm:pt-24 pt-12">
        <h1
          className="lg:text-7xl sm:text-5xl text-4xl text-center uppercase text-white underline decoration-purple-300 lg:decoration-8 decoration-4 font-semibold lg:py-4 py-2"
          style={{ font: "'Oswald', sans-serif" }}
        >
          Contact Me
        </h1>
        <h2 className="lg:text-md sm:text-sm text-xs">
          Available for professional work and select freelance opportunities
        </h2>
        ...
        <div className="contact-wrapper">
          ...
          >
            ...
            <button
              className="btn btn-primary send-button flex justify-center"
              style={{ backgroundColor: "rgb(165, 165, 252)" }}
              id="submit"
              type="submit"
              value="SEND"
            >
              <div className="alt-send-button">
                <BiPaperPlane
                  size="24"
                  className="fa fa-paper-plane fa-2x mx-auto"
                />
          ...
          <div>
            ...
            <div className="copyright">
              &copy; 2023 Roy Lee. All Rights Reserved
            </div>
          </div>
        </div>
      </div>
